#!/bin/bash
# =============================================================================
# Video Depth Anything (tiny) scratch run (50 epochs)
# GT + cached-teacher distillation + MTKD-style aggregation loss.
# =============================================================================

#SBATCH --job-name=vda_tiny_mtkd
...
CONFIG="${CONFIG:-configs/experiments/tartanair_vda_tiny_scratch_distill_mtkd_50ep.yaml}"
EXTRA_TRAIN_ARGS="${EXTRA_TRAIN_ARGS:-}"

echo "========================================"
echo " VDA-Tiny Scratch MTKD Distillation"
