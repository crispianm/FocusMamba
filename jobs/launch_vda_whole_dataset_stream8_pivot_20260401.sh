...
submit_bench() {
  ...
  sbatch \
    ...
    --export="ALL,PROJECT_DIR=${PROJECT_DIR},CONFIG=${config_path},CHECKPOINT_PATH=${checkpoint_path},CHECKPOINT_LABEL=${checkpoint_label},CHECKPOINT_VARIANT=small,NUM_EVAL_CLIPS=32,NUM_DISPLAY_CLIPS=2,IMAGE_SIZE=392,OUTPUT_DIR=${output_dir},OUTPUT_PREFIX=${checkpoint_label}_degraded_eval" \
    "$BENCH_RUNNER"
}
